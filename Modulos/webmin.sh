...
echo -e "\033[1;34mDESEA CONTINUAR? [S/N]: \033[0;32m"; read x
 [[ $x = @(n|N) ]] && msg -bar && return
 fun_bar "apt-get remove webmin -y"
echo -e "\033[1;34m[\033[1;37m•\033[1;34m]\033[1;37m ➩ \033[1;33mELIMINADO CON EXITO \033[0;32m"
...
echo -ne "\033[1;34mEstamos listos para configurar tu servidor Webmin \033[0;32m"
...
service webmin restart > /dev/null 2>&1
fun_ip
echo -e "\033[1;34mAcesso via web link \033[0;32mhttps://$IP:10000"
echo -e ""
echo -ne "\n\033[1;31mENTER \033[1;33mpara volver \033[1;32mMENU!\033[0m"; read
}
web_min
